...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ibm-watson-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10069&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ibm-watson-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ibm-watson` can be installed with:

```
conda install ibm-watson
```

It is possible to list all of the versions of `ibm-watson` available on your platform with:
